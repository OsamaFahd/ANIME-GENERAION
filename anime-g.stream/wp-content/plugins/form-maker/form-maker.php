...
final class WDFM {
  ...
  private function define_constants() {
    ...
    $this->plugin_version = '1.13.17';
    $this->db_version = '2.13.17';
  ...
  */
  ...
  public function webinar_banner() {
    ...
    new TWFMWebinar(array(
      ...
      'description' => 'How to Create Fully Functional WP Website with Various Forms in Just an Hour + SPECIAL GIFT FOR WEBINAR ATTENDEES',
