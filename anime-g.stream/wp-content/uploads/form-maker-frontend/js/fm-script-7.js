    ...
    var labels_and_ids7 = {"2":"type_textarea","3":"type_spinner","4":"type_own_select","5":"type_textarea","1":"type_submit_reset"};
    var check_regExp_all7 = [];
    var check_paypal_price_min_max7 = [];
    var file_upload_check7 = [];
    var spinner_check7 = {"3":["",""]};
 ...
 function after_submit7() {
    ...
    function onload_js7() {
  jQuery("#form7 #wdform_3_element7")[0].spin = null;
  spinner = jQuery("#form7 #wdform_3_element7").spinner();
  if ("null" == "null" && jQuery("#form7 #wdform_3_element7").val() == "") { spinner.spinner("value", ""); }
  jQuery("#form7 #wdform_3_element7").spinner({ min: ""});
  jQuery("#form7 #wdform_3_element7").spinner({ max: ""});
  jQuery("#form7 #wdform_3_element7").spinner({ step: "1"});    }
